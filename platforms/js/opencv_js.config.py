...
features2d = {'Feature2D': ['detect', 'compute', 'detectAndCompute', 'descriptorSize', 'descriptorType', 'defaultNorm', 'empty', 'getDefaultName'],
              ...
              'SIFT': ['create', 'getContrastThreshold', 'getDefaultName', 'getEdgeThreshold', 'getNFeatures', 'getNOctaveLayers', 'getSigma', 'setContrastThreshold', 'setEdgeThreshold', 'setNFeatures', 'setNOctaveLayers', 'setSigma', 'compute', 'defaultNorm', 'descriptorSize', 'descriptorType', 'detect', 'detectAndCompute', 'empty', 'read', 'write', 'save'],
